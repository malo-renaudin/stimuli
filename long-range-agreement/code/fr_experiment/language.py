...
PLACE_PREPOSITION_OPTIONS = {
    ...
    "étage": ["dans"],
    "espace": ["dans", "loin de"],
    "établissement": ["dans", "devant", "près de"],
    "observatoire": ["dans", "près de", "devant"],
    "amphithéâtre": ["dans", "près de", "devant"],
    "entrepôt": ["dans", "à côté de", "loin de"],
    "institut": ["dans", "devant", "près de", "à gauche de"],
    "auditorium": ["dans", "derrière", "près de", "devant"],
    "office": ["dans", "à côté de", "près de"],
    "abri": ["dans", "près de"],
    "avenue": ["devant", "près de", "en face de"],
    "école": ["dans", "devant", "près de", "à droite de"],
    "usine": ["dans", "près de"],
    "île": ["dans"],
    "entrée": ["devant", "près de", "dans"],
    "allée": ["dans", "à côté de"],
    "impasse": ["dans", "à côté de", "près de"],
    "agence": ["dans", "près de"],
    "église": ["dans", "derrière", "devant", "près de"],
    "université": ["dans", "devant", "près de", "à gauche de"],
    "enceinte": ["dans"],
    "auberge": ["dans", "près de"],
    "arène": ["dans", "devant", "près de"],
}
